...
class TestImageHash(unittest.TestCase):
    ...
    def test_sha512_for_vec(self):
        vec = np.array([1, 2, 3])
        ret = hash.image.sha512_for_vec(vec)
